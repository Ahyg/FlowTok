...
#PBS -m abe
#PBS -N Sat2Radar_v2v_newposemb_validate
...
CONFIG_PATH="${FLOWTOK_ROOT}/configs/Sat2Radar-v2v-newposemb-FlowTiTok-XL_gadi.py"
CKPT_PATH="/scratch/kl02/$USER/Projv2v/Experiments/sat2radar_flowtok_run_v2v_newposemb/ckpts/100000.ckpt"
OUTPUT_DIR="/scratch/kl02/$USER/Projv2v/Experiments/sat2radar_flowtok_run_v2v_newposemb/validate_v2v_100000"
...
python scripts/validate_sat2radar_v2v.py \
  ...
  > /scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_sat2radar_v2v_newposemb_validate.log 2>&1
