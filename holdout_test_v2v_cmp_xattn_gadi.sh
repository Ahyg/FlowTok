...
JOBLOG=/scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_htest_v2v_xattn.log
cd $FT
...
echo "[$(date '+%F %T')] xattn v2v holdout test done: $OUT/metrics.json"
