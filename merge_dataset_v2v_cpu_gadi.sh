...
mkdir -p "${JOB_LOG_DIR}"
LOG_PATH="${JOB_LOG_DIR}/${PBS_JOBID}_merge_v2v.log"
exec > "${LOG_PATH}" 2>&1
...
train_p = base / "dataset_filelist_v2v_train_201906_202312.pkl"
val_p = base / "dataset_filelist_v2v_val_202401_202406.pkl"
test_p = base / "dataset_filelist_v2v_test_202407_202507.pkl"
out_p = base / "dataset_filelist_v2v_timeblock_201906_202507.pkl"
