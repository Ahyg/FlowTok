...
CONFIG_PATH="${FLOWTOK_ROOT}/configs/Sat2Radar-v2v-satlight-seqconcat-FlowTiTok-XL_gadi.py"
...
accelerate launch \
  ...
  > /scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_v2v_seqconcat_tiny.log 2>&1
