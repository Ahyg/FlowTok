...
for step in 50000 100000 150000 200000; do
  run_test "${RADAR_CFG}" "radar_flowtitok_ae_bl77_vae_scratch_run1_gadi" "${step}"
done
for step in 50000 100000 150000 200000; do
  run_test "${RADAR_CFG}" "radar_flowtitok_ae_bl77_vae_scratch_run2_gadi" "${step}"
done

# ────────────── sat run1 / run2 ──────────────
for step in 50000 100000 150000 200000; do
  run_test "${SAT_CFG}" "sat_flowtitok_ae_bl77_vae_scratch_run1_gadi" "${step}"
done
for step in 50000 100000 150000 200000; do
  run_test "${SAT_CFG}" "sat_flowtitok_ae_bl77_vae_scratch_run2_gadi" "${step}"
done
