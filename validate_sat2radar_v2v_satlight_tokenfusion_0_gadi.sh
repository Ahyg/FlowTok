...
#PBS -m abe
#PBS -N Sat2Radar_v2v_satlight_validate
...
CKPT_ROOT="/scratch/kl02/$USER/Projv2v/Experiments/sat2radar_flowtok_run_v2v_satlight_tokenfusion/ckpts"
RUN_ROOT="/scratch/kl02/$USER/Projv2v/Experiments/sat2radar_flowtok_run_v2v_satlight_tokenfusion"
...
# 多个 step：空格分隔；例如 qsub 前: export STEPS="80000 116000 117000"
STEPS=${STEPS:-"20000 40000 60000 80000 100000"}
...
mkdir -p "${JOB_LOG_DIR}"
SUMMARY_LOG="${JOB_LOG_DIR}/${PBS_JOBID:-manual}_sat2radar_v2v_satlight_validate_summary.log"
VAL_LOSS_LOG="${JOB_LOG_DIR}/${PBS_JOBID:-manual}_sat2radar_v2v_satlight_validate_val_loss.log"
MAIN_LOG="${JOB_LOG_DIR}/${PBS_JOBID:-manual}_sat2radar_v2v_satlight_validate.log"

{
  ...
  for STEP in ${STEPS}; do
    ...
    OUTPUT_DIR="${RUN_ROOT}/validate_v2v_${STEP}"
    echo ""
    echo "========== STEP=${STEP} =========="
