...
JOBLOG=/scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_htest_v2v_m8align_s20.log
cd $FT
...
run_test () {
  ...
  mkdir -p "$OUT"
  echo "[$(date '+%F %T')] v2v m8align s20 $TAG -> $OUT" >> "$JOBLOG"
...
echo "[$(date '+%F %T')] v2v m8align s20 holdouts done."
