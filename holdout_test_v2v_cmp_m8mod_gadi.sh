...
JOBLOG=/scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_htest_v2v_m8mod.log
cd $FT
...
echo "[$(date '+%F %T')] m8mod v2v holdout test done: $OUT/metrics.json"
