...
# Only train uses halfvalid50+ct005 (val/test stay nofilter on lab).
SPLIT="${SPLIT:-train}"
...
case "${SPLIT}" in
  train)
    START_DATE="20210501"
    END_DATE="20211031"
    OUT_NAME="dataset_filelist_v2v_train_202105_202110_halfvalid50_ct005.pkl"
    SPLIT_RATIO="1,0,0"
    ;;
  *)
    echo "[ERROR] Unknown SPLIT=${SPLIT}. Only 'train' supported for halfvalid50 locally." >&2
    exit 1
    ;;
esac
