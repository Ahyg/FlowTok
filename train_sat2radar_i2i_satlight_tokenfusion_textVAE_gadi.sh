...
CONFIG_PATH="${FLOWTOK_ROOT}/configs/Sat2Radar-i2i-satlight-tokenfusion-textVAE-FlowTiTok-XL_gadi.py"
...
accelerate launch \
  ...
  2>&1 | tee /scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_i2i_satlight_textVAE.log
