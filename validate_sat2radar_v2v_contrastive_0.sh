...
# Pure visualization (no metrics) for Sat2Radar v2v run (textVAE contrastive)
...
OUTPUT_DIR="/mnt/ssd_1/yghu/Experiments/sat2radar_flowtok_run_v2v_contrastive/validate_v2v_100000"
