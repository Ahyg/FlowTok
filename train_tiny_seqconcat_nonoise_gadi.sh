...
CONFIG_PATH="${FLOWTOK_ROOT}/configs/tiny_seqconcat_nonoise_test.py"
...
accelerate launch \
  ...
  --config="${CONFIG_PATH}" \
  > /scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_tiny_seqconcat_nonoise.log 2>&1
