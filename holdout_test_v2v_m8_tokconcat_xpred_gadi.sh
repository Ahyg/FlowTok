...
#PBS -m abe
#PBS -N htest_v2v_m8tcxp
# Holdout test for the 6-year full FlowTiTok-XL run m8_tokconcat_xpred (block M8).
...
JOBLOG=/scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_htest_v2v_m8tcxp.log
cd $FT
...
echo "[$(date '+%F %T')] m8_tokconcat_xpred v2v holdout test done: $OUT/metrics.json"
