...
#PBS -m abe
#PBS -N FlowTiTok_AE_radar_scratch_train
...
CONFIG_PATH="${FLOWTOK_ROOT}/configs/radar_flowtitok_ae_bl77_vae_scratch_gadi.yaml"
...
accelerate launch \
  ...
  --config="${CONFIG_PATH}" \
  > "/scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_train_radar_flowtitok_ae_scratch.log" 2>&1
