...
CONFIG_PATH="${FLOWTOK_ROOT}/configs/radar_flowtitok_ae_bl128_vae_scratch_run4_overfit_gadi.yaml"
...
accelerate launch \
  ...
  --config="${CONFIG_PATH}" \
  > "/scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_train_radar_ae_bl128_run4_overfit.log" 2>&1
