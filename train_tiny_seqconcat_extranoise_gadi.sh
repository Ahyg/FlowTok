...
CONFIG_PATH="${FLOWTOK_ROOT}/configs/tiny_seqconcat_extranoise_test.py"
...
accelerate launch \
  ...
  --config="${CONFIG_PATH}" \
  > /scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_tiny_seqconcat_extranoise.log 2>&1
