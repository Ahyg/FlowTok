...
case "${SPLIT}" in
  val)
    START_DATE="20240601"
    END_DATE="20240630"
    OUT_NAME="dataset_filelist_i2i_val_202406_nofilter.pkl"
    SPLIT_RATIO="0,1,0"
    ;;
  val_small)
    START_DATE="20240601"
    END_DATE="20240607"
    OUT_NAME="dataset_filelist_i2i_val_202406w1_nofilter.pkl"
    SPLIT_RATIO="0,1,0"
    ;;
  test)
    START_DATE="20240701"
    END_DATE="20240731"
    OUT_NAME="dataset_filelist_i2i_test_202407_nofilter.pkl"
    SPLIT_RATIO="0,0,1"
    ;;
  *)
