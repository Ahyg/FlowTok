...
mkdir -p "${JOB_LOG_DIR}"
LOG_PATH="${JOB_LOG_DIR}/${PBS_JOBID}_build_i2i_ct005_${SPLIT}.log"
exec > "${LOG_PATH}" 2>&1
...
case "${SPLIT}" in
  train)
    START_DATE="20190601"
    END_DATE="20231231"
    OUT_NAME="dataset_filelist_i2i_train_201906_202312_ct005.pkl"
    SPLIT_RATIO="1,0,0"
    ;;
  val)
    START_DATE="20240101"
    END_DATE="20240630"
    OUT_NAME="dataset_filelist_i2i_val_202401_202406_ct005.pkl"
    SPLIT_RATIO="0,1,0"
    ;;
  test)
    START_DATE="20240701"
    END_DATE="20250731"
    OUT_NAME="dataset_filelist_i2i_test_202407_202507_ct005.pkl"
    SPLIT_RATIO="0,0,1"
    ;;
  *)
