...
#PBS -m abe
#PBS -N FlowTiTok_AE_sat10ch_scratch_train
...
CONFIG_PATH="${FLOWTOK_ROOT}/configs/sat10ch_flowtitok_ae_bl77_vae_scratch_gadi.yaml"
...
accelerate launch \
  ...
  --config="${CONFIG_PATH}" \
  > "/scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_train_sat10ch_flowtitok_ae_scratch.log" 2>&1
