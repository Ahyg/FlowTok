...
#PBS -m abe
#PBS -N Sat2Radar_i2i_noTextVAE_validate
...
CKPT_PATH="/scratch/kl02/$USER/Projv2v/Experiments/sat2radar_flowtok_run_i2i_noTextVAE/ckpts/100000.ckpt"
OUTPUT_DIR="/scratch/kl02/$USER/Projv2v/Experiments/sat2radar_flowtok_run_i2i_noTextVAE/validate_i2i_100000"
...
python scripts/validate_sat2radar_v2v.py \
  ...
  > /scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_sat2radar_i2i_noTextVAE_validate.log 2>&1
