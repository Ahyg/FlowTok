...
CONFIG_PATH="${FLOWTOK_ROOT}/configs/Sat2Radar-v2v-satlight-tokenconcat-v5-FlowTiTok-XL_gadi.py"
...
accelerate launch \
  ...
  > /scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_sat2radar_v2v_tokenconcat_v5.log 2>&1
