...
#PBS -m abe
#PBS -N Sat2Radar_i2i_FlowTokL_train
...
CONFIG_PATH="${FLOWTOK_ROOT}/configs/Sat2Radar-i2i-satlight-tokenfusion-FlowTiTok-L_gadi.py"
...
accelerate launch \
  ...
  > /scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_sat2radar_i2i_FlowTokL_train.log 2>&1
