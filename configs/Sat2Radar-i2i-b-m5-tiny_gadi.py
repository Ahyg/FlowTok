"""M5 tiny — overfit gate for the token-concat diffusion variant."""
...
def get_config():
    ...
    config.dataset = d(
        filelist_path=(
            "/scratch/kl02/yh0308/Projv2v/Experiments/"
            "sat2radar_flowtok_i2i_b_diffusion_tokconcat_2021summer_tiny/dataset_filelist.pkl"
        ),
    ...
    config.workdir = (
        "/scratch/kl02/yh0308/Projv2v/Experiments/"
        "sat2radar_flowtok_i2i_b_diffusion_tokconcat_2021summer_tiny"
    )
