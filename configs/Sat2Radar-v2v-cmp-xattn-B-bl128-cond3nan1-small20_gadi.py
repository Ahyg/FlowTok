"""v2v cmp — Arm xattn (cross-attention conditioning).

bl128 tokenizer (run4Bftgan / run4ftgan @ 300k, cond1 train) + cond3nan1 small20.
...
def get_config():
    ...
    config.dataset = d(
        filelist_path=(
            ...
            "dataset_filelist_v2v_train_201906_202406_cond3nan1_clip16_p005_seed42_small20.pkl"
        ),
    ...
    config.workdir = (
        "/scratch/kl02/yh0308/Projv2v/Experiments/"
        "sat2radar_flowtok_v2v_cmp_xattn_B_bl128_cond3nan1_small20"
    )
