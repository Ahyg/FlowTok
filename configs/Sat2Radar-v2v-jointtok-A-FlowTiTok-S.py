...
# Joint-tokenizer experiment, Group A: FlowTok-S v2v on the joint_ae_sep_run1 tiny+small
...
def get_config():
    ...
    config.sat_tokenizer_checkpoint = (
        "/mnt/ssd_2/yghu/Experiments/joint_ae_sep_run1/sat/checkpoint-best_val/pytorch_model.bin"
    )
    config.radar_tokenizer_checkpoint = (
        "/mnt/ssd_2/yghu/Experiments/joint_ae_sep_run1/radar/checkpoint-best_val/pytorch_model.bin"
    )
    ...
    config.workdir = (
        "/mnt/ssd_2/yghu/Experiments/v2v_jointtok_A_run1"
    )
