...
# - sat AE: sat10ch run3 (11 in/out channels, 77 tokens, 16-dim)
# - radar AE: radar run3 (1 in/out channels, 77 tokens, 16-dim)
...
def get_config():
    ...
    # sat10ch / radar run3 AE was trained at 128 crop.
    ...
    config.workdir = (
        "/scratch/kl02/yh0308/Projv2v/Experiments/"
        "sat2radar_flowtok_run_v2v_sat10ch_direct_run3_full"
    )
