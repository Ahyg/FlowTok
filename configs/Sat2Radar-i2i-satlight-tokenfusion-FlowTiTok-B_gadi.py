...
def get_config():
    ...
    global model
    # FlowTok-B: depth=12, hidden=768, 12 heads (much smaller than XL)
    config.nnet = d(
        name="flowtok-b",
        model_args=model,
    )
    ...
    # sat IR + lightning token fusion (mean, same as baseline)
    ...
    config.workdir = "/scratch/kl02/yh0308/Projv2v/Experiments/sat2radar_flowtok_run_i2i_satlight_tokenfusion_B"
