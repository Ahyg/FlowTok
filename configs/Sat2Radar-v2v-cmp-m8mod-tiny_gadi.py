"""7-arm v2v comparison — Arm 6 TINY (m8mod): 32-clip overfit, 12k steps.

Tiny version of m8mod-B for fast sanity-check / overfit gate before full run.
Same settings as m8mod-B except: 32-clip dataset, 12k steps, faster eval/save.

  - flow_cond_mode = token_concat_modality
...
def get_config():
    ...
    config.dataset = d(
        filelist_path=(
            "/scratch/kl02/yh0308/Projv2v/Experiments/"
            "sat2radar_flowtok_v2v_cmp_m8mod_tiny/dataset_filelist.pkl"
        ),
    ...
    config.workdir = (
        "/scratch/kl02/yh0308/Projv2v/Experiments/"
        "sat2radar_flowtok_v2v_cmp_m8mod_tiny"
    )
