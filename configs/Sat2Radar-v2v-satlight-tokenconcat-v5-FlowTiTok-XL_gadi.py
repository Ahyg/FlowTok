...
def get_config():
    ...
    # v5 concat-fusion auxiliary losses
    config.losses = d(
    ...
    # Full dataset filelist (v2v, time-block split)
    config.dataset = d(
    ...
    config.workdir = "/scratch/kl02/yh0308/Projv2v/Experiments/sat2radar_flowtok_run_v2v_tokenconcat_v5_full"
