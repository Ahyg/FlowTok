...
def get_config():
    ...
    # M4 change: keep flow ODE but predict radar tokens (x1) instead of velocity.
    ...
    config.dataset = d(
        filelist_path=(
            "/scratch/kl02/yh0308/Projv2v/Experiments/"
            "sat2radar_flowtok_i2i_b_xpred_2021summer_tiny/dataset_filelist.pkl"
        ),
    ...
    config.workdir = (
        "/scratch/kl02/yh0308/Projv2v/Experiments/"
        "sat2radar_flowtok_i2i_b_xpred_2021summer_tiny"
    )
