"""v2v fact (xattn + factorized attn) — 80/20 train/val RETRAIN @ 800k.

IDENTICAL to Sat2Radar-v2v-cmp-fact-B-bl128-cond3nan1_gadi.py EXCEPT:
  - dataset.filelist_path -> the content-matched 80/20 split (train=3552 clips, val=888 clips)
  - workdir -> sat2radar_flowtok_v2v_fact_t80v20_800k
Train reads split "train" (80%); per-ckpt val eval reads split "val" (20%) via test_sat2radar_v2v.py --split val.
"""
...
def get_config():
    ...
    config.dataset = d(
        filelist_path=(
            ...
            "dataset_filelist_v2v_train80val20_from_cond3nan1_seed42.pkl"
        ),
    ...
    config.workdir = (
        "/scratch/kl02/yh0308/Projv2v/Experiments/"
        "sat2radar_flowtok_v2v_fact_t80v20_800k"
    )
