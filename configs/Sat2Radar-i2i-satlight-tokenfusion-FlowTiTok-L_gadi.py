...
def get_config():
    ...
    global model
    # FlowTok-L: depth=24, hidden=1024, 16 heads (smaller than XL)
    config.nnet = d(
        name="flowtok-l",
        model_args=model,
    )
    ...
    config.workdir = "/scratch/kl02/yh0308/Projv2v/Experiments/sat2radar_flowtok_run_i2i_satlight_tokenfusion_L"
