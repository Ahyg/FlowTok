...
# InfoNCE SWEEP cell w050 (w=0.5, big-budget 40000-step v2v): FlowTok-S on joint_ae_infonce_w050_run1 tiny+small
...
def get_config():
    ...
    config.sat_tokenizer_checkpoint = (
        "/mnt/ssd_2/yghu/Experiments/joint_ae_infonce_w050_run1/sat/checkpoint-best_val/pytorch_model.bin"
    )
    config.radar_tokenizer_checkpoint = (
        "/mnt/ssd_2/yghu/Experiments/joint_ae_infonce_w050_run1/radar/checkpoint-best_val/pytorch_model.bin"
    )
    ...
    config.workdir = (
        "/mnt/ssd_2/yghu/Experiments/v2v_jointtok_infonce_w050_run1"
    )
