"""Capacity-scaling of Arm 7 (xattn) — S backbone.

Identical to Sat2Radar-v2v-cmp-xattn-B-2021summer_gadi.py EXCEPT the DiT size
is flowtok-S (depth12/hidden384, smallest) instead of flowtok-B. Same
...
def get_config():
    ...
    config.workdir = (
        "/scratch/kl02/yh0308/Projv2v/Experiments/"
        "sat2radar_flowtok_v2v_cmp_xattn_S"
    )
