...
model = Args(
    ...
    noising_type="none",
    noising_scale=0.1,
    use_t2t_temperature=True,  # Enable t2t temperature for contrastive loss
    textVAE=Args(
        num_blocks=6,
        hidden_dim=256,
...
def get_config():
    ...
    # ========= checkpoint / 日志 / 采样 =========
    config.workdir = "/mnt/ssd_1/yghu/Experiments/sat2radar_video_run"
    config.ckpt_root = "/mnt/ssd_1/yghu/Experiments/sat2radar_video_run/ckpts"
    config.sample_dir = "/mnt/ssd_1/yghu/Experiments/sat2radar_video_run/samples"
    ...
    config.sample = d(
        ...
        scale=2.0,
        noise_scale=0.1,
        path="/mnt/ssd_1/yghu/Experiments/sat2radar_video_run/samples_eval",
    )
