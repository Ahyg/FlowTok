"""Capacity-scaling of Arm 7 (xattn) — H backbone.

Identical to Sat2Radar-v2v-cmp-xattn-B-2021summer_gadi.py EXCEPT the DiT size
is flowtok-H (depth36/hidden1280, ~1.07B) instead of flowtok-B (~130M). Same
...
def get_config():
    ...
    config.workdir = (
        "/scratch/kl02/yh0308/Projv2v/Experiments/"
        "sat2radar_flowtok_v2v_cmp_xattn_H"
    )
