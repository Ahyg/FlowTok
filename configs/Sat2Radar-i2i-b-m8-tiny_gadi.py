"""M8 tiny — overfit gate for token_concat+xpred flow.

Reuses the i2i baseline tiny filelist (32 samples), 5k steps.
"""
...
def get_config():
    ...
    config.workdir = (
        "/scratch/kl02/yh0308/Projv2v/Experiments/"
        "sat2radar_flowtok_i2i_b_flow_tokconcat_xpred_2021summer_tiny"
    )
