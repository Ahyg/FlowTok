...
# Uni-directional sat10ch-direct + small DiT (FlowTok-S, ~30M params): forward-only FlowTok-XL,
# matches the bidir config exactly except bidir.beta=0 (no reverse direction).
# Used as the apples-to-apples control vs the bidir run.
...
def get_config():
    ...
    config.workdir = (
        ...
        "sat2radar_flowtok_v2v_uni_sat10ch_S_run1"
    )
