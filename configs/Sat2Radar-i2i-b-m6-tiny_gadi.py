"""M6 tiny — overfit gate for M2-variant: kld 1e-6 + noising 'none'."""
...
def get_config():
    ...
    config.dataset = d(
        filelist_path=(
            "/scratch/kl02/yh0308/Projv2v/Experiments/"
            "sat2radar_flowtok_i2i_b_textvae_lowkld_2021summer_tiny/dataset_filelist.pkl"
        ),
    ...
    config.workdir = (
        "/scratch/kl02/yh0308/Projv2v/Experiments/"
        "sat2radar_flowtok_i2i_b_textvae_lowkld_2021summer_tiny"
    )
