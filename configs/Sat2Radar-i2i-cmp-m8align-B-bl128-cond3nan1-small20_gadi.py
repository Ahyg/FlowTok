"""i2i cmp — Arm m8align (token_concat_interleaved + radar_tokens flow).

bl128 tokenizer (run4Bftgan / run4ftgan @ 300k, cond1 train) + cond3nan1 small20.
  - model size = flowtok-b
  - 100k steps, bs=64, num_frames=1
"""
...
def get_config():
    ...
    config.workdir = (
        "/scratch/kl02/yh0308/Projv2v/Experiments/"
        "sat2radar_flowtok_i2i_cmp_m8align_B_bl128_cond3nan1_small20"
    )
