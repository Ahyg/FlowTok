...
JOBLOG=/scratch/kl02/$USER/Projv2v/job_logs/${PBS_JOBID}_htest_v2v_satenc.log
cd $FT
...
echo "[$(date '+%F %T')] satenc v2v holdout test done: $OUT/metrics.json"
